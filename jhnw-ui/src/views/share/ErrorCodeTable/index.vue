  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="错误代码信息" prop="errorCodeInformation">
        <el-input
          ...
          placeholder="请输入错误代码信息"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="错误解决办法" prop="errorSolution">
        <el-input
          v-model="queryParams.errorSolution"
          placeholder="请输入错误解决办法"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['share:ErrorCodeTable:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['share:ErrorCodeTable:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['share:ErrorCodeTable:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['share:ErrorCodeTable:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="错误解决办法" prop="errorSolution">
          <el-input v-model="form.errorSolution" placeholder="请输入错误解决办法" />
        </el-form-item>
      </el-form>
...
<script>
import { listErrorCodeTable, getErrorCodeTable, delErrorCodeTable, addErrorCodeTable, updateErrorCodeTable, exportErrorCodeTable } from "@/api/share/ErrorCodeTable";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        errorSolution: [
          { required: true, message: "错误解决办法不能为空", trigger: "blur" }
        ],
        createTime: [
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listErrorCodeTable(this.queryParams).then(response => {
        this.ErrorCodeTableList = response.rows;
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.errorCodeNumber != null) {
            ...
            addErrorCodeTable(this.form).then(response => {
    ...
    handleExport() {
      ...
      this.$modal.confirm('是否确认导出所有错误代码数据项？').then(() => {
        this.exportLoading = true;
        return exportErrorCodeTable(queryParams);
      }).then(response => {
