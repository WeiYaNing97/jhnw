  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['advanced:errorrate:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['advanced:errorrate:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['advanced:errorrate:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['advanced:errorrate:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="output errors" prop="outputErrors">
          <el-input v-model="form.outputErrors" placeholder="请输入output errors" />
        </el-form-item>
        <el-form-item label="crc" prop="crc">
...
<script>
import { listErrorrate, getErrorrate, delErrorrate, addErrorrate, updateErrorrate, exportErrorrate } from "@/api/advanced/errorrate";
  ...
  methods: {
    ...
    getList() {
      ...
      listErrorrate(this.queryParams).then(response => {
        this.errorrateList = response.rows;
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateErrorrate(this.form).then(response => {
              this.$modal.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
          } else {
            addErrorrate(this.form).then(response => {
