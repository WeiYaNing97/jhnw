    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['sql:switch_failure:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['sql:switch_failure:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['sql:switch_failure:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['sql:switch_failure:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listSwitch_failure, getSwitch_failure, delSwitch_failure, addSwitch_failure, updateSwitch_failure, exportSwitch_failure } from "@/api/sql/switch_failure";
