    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['sql:switch_scan_result:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['sql:switch_scan_result:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['sql:switch_scan_result:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['sql:switch_scan_result:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listSwitch_scan_result, getSwitch_scan_result, delSwitch_scan_result, addSwitch_scan_result, updateSwitch_scan_result, exportSwitch_scan_result } from "@/api/sql/switch_scan_result";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        subVersion: [
          { required: true, message: "子版本号不能为空", trigger: "blur" }
        ],
        switchName: [
