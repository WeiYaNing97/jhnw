...
public class YmlUtils {
    ...
    public static String getValue(String key, String path) throws FileNotFoundException {
        Map<String,String> map = getYmlByFileName(path);
        if(map==null)return null;
        return map.get(key);
    }
     ...
     * @return
     */
    public static Map<String,String> forEachYaml(String key_str,Map<Object, Object> obj, int i, String... keys){
     ...
     * @return
     */
    public static String getApplicationName(String nameValue) throws FileNotFoundException {
        return getYmlByFileName(bootstrap_file).get(nameValue);
    }
    ...
    public static String getApplicationName() throws FileNotFoundException {
        String name =  getYmlByFileName(bootstrap_file).get("configuration.enabled");
        return name;
    }
}
